...
DOCUMENTATION = r'''
    ...
    extends_documentation_fragment:
        - constructed
    description:
        - Get inventory hosts from Vultr bare metal service.
    ...
    options:
        plugin:
            description: Token that ensures this is a source file for the 'vultr_metal' plugin.
            type: string
            required: True
            choices: [ vultr ]
        api_account:
...
def _retrieve_servers(api_key, tag_filter=None):
    api_url = '%s/v1/baremetal/list' % VULTR_API_ENDPOINT
